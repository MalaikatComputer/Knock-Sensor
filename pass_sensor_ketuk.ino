/* 
   ...
   pembuka pintu otomatis menggunakan sensor ketuk
...
#define RELAY_ON 0
#define RELAY_OFF 1
#define RELAY_1  11   // pin yang digunakan yaitu pin 3

 
// Pin yang digunakan
const int knockSensor = 0;         // Piezo sensor di pin 0.
const int programSwitch = 16;       // digunakan untuk memprogram ketukan baru
const int redLED = 14;              // Status LED
const int greenLED = 15;            // Status LED
 

const int threshold = 11;           // Minimum signal from the piezo to register as a knock
